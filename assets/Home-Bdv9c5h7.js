 ...
 */const S=[["path",{d:"M12 5l0 14",key:"svg-0"}],["path",{d:"M18 13l-6 6",key:"svg-1"}],["path",{d:"M6 13l6 6",key:"svg-2"}]],I=_("outline","arrow-down","ArrowDown",S),A=n.lazy(()=>v(()=>import("./CinematicScene-530VElJ8.js"),__vite__mapDeps([0,1,2,3])));f.registerPlugin(d);const T=[{org:"IBM",role:"Lead Full-Stack Developer",note:"Microservices · Kafka · CI/CD"},{org:"EPFL",role:"Senior Full-Stack Developer",note:"AWS data infra · research platforms"},{org:"AICA",role:"Frontend Engineer",note:"Robotics UI · TypeScript · Go"}],E=["Intro","Craft","Path","Numbers","Next"],g=[0,.22,.42,.64,.83],M=i=>{let r=0;for(let t=0;t<g.length;t++)i>=g[t]&&(r=t);return r},C=()=>{const i=n.useRef(null),r=n.useRef(0),t=n.useRef(0),[s,o]=n.useState(0);return n.useEffect(()=>{const a=i.current;if(!a)return;const c=d.create({trigger:a,start:"top top",end:"bottom bottom",scrub:!0,onUpdate:x=>{r.current=x.progress;const m=M(x.progress);m!==t.current&&(t.current=m,o(m))}});return d.refresh(),()=>c.kill()},[]),e.jsxs("section",{className:"stage",ref:i,children:[e.jsxs("div",{className:"stage__pin",children:[e.jsx(n.Suspense,{fallback:null,children:e.jsx(A,{progress:r})}),e.jsx("div",{className:"stage__vignette","aria-hidden":"true"}),e.jsx("div",{className:"stage__rail","aria-hidden":"true",children:E.map((a,c)=>e.jsxs("span",{className:`stage__tick ${c===s?"is-active":""} ${c<s?"is-done":""}`,children:[e.jsx("i",{}),e.jsx("em",{children:a})]},a))}),e.jsxs("div",{className:"stage__acts",children:[e.jsx("div",{className:`c-act c-act--left ${s===0?"is-active":""}`,children:e.jsxs("div",{className:"container",children:[e.jsx("p",{className:"eyebrow",children:"Senior Full-Stack Engineer  /  Geneva, CH"}),e.jsxs("h1",{className:"c-hero display",children:["Software, ",e.jsx("span",{className:"gradient-text",children:"engineered"}),e.jsx("br",{}),"to feel ",e.jsx("span",{className:"gradient-text--warm",children:"alive"}),"."]}),e.jsx("p",{className:"c-sub",children:"I’m Hassan Shahzad — a senior full-stack engineer who also designs and ships award-grade interfaces. This whole scene is hand-written GLSL, driven by your scroll."}),e.jsxs("div",{className:"c-actions",children:[e.jsx(h,{strength:.4,children:e.jsxs(l,{to:"/projects",className:"btn btn--primary btn--lg",children:[e.jsx("span",{children:"View my work"}),e.jsx(p,{size:19})]})}),e.jsx(h,{strength:.4,children:e.jsx(l,{to:"/contact",className:"btn btn--ghost btn--lg",children:e.jsx("span",{children:"Get in touch"})})})]})]})}),e.jsx("div",{className:`c-act c-act--left ${s===1?"is-active":""}`,children:e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"c-index",children:"01 — What I do"}),e.jsxs("h2",{className:"c-statement display",children:["I turn complex systems into interfaces that feel"," ",e.jsx("span",{className:"gradient-text",children:"inevitable"}),"."]})]})}),e.jsx("div",{className:`c-act c-act--right ${s===2?"is-active":""}`,children:e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"c-index",children:"02 — The path"}),e.jsx("h2",{className:"c-statement display c-statement--sm",children:"A global trajectory."}),e.jsx("ul",{className:"c-miles",children:T.map(a=>e.jsxs("li",{className:"c-mile",children:[e.jsx("span",{className:"c-mile__org gradient-text",children:a.org}),e.jsx("span",{className:"c-mile__role",children:a.role}),e.jsx("span",{className:"c-mile__note",children:a.note})]},a.org))})]})}),e.jsx("div",{className:`c-act c-act--center ${s===3?"is-active":""}`,children:e.jsxs("div",{className:"container",children:[e.jsx("span",{className:"c-index",children:"03 — By the numbers"}),e.jsx("div",{className:"c-stats",children:N.map(a=>e.jsxs("div",{className:"c-stat",children:[e.jsx("span",{className:"c-stat__value display gradient-text",children:a.value}),e.jsx("span",{className:"c-stat__label",children:a.label})]},a.label))})]})}),e.jsx("div",{className:`c-act c-act--center ${s===4?"is-active":""}`,children:e.jsxs("div",{className:"container c-next",children:[e.jsx("span",{className:"c-index",children:"04 — Now the specifics"}),e.jsxs("h2",{className:"c-statement display",children:["Let’s get ",e.jsx("span",{className:"gradient-text--warm",children:"specific"}),"."]}),e.jsx("p",{className:"c-sub c-sub--center",children:"Keep scrolling — selected work and voices below."}),e.jsx(I,{size:22,className:"c-next__arrow"})]})})]})]}),e.jsx("style",{children:`
      ...
      `})]})},R=({items:i=[]})=>{const r=[...i,...i];return e.jsx("div",{className:"marquee","aria-hidden":"true",children:e.jsx("div",{className:"marquee__track",children:r.map((t,s)=>e.jsx("span",{className:"marquee__item",children:t},`${t}-${s}`))})})},G=()=>{const i=u(),{projects:r}=j(),t=n.useMemo(()=>r.filter(a=>a.featured).slice(0,6),[r]),s=n.useMemo(()=>w.slice(0,3),[]),o=a=>{i(`/projects?project=${a.id}`)};return e.jsxs(e.Fragment,{children:[e.jsx(C,{}),e.jsx(R,{items:y}),e.jsxs("section",{className:"section container",children:[e.jsxs("div",{className:"section-head",children:[e.jsxs("div",{children:[e.jsx("span",{className:"section-index","data-reveal":!0,children:"Selected work"}),e.jsx("h2",{className:"section-title","data-reveal":!0,"data-reveal-delay":80,children:"Featured projects"})]}),e.jsxs(l,{to:"/projects",className:"btn btn--ghost","data-reveal":!0,"data-reveal-delay":120,children:[e.jsx("span",{children:"All projects"}),e.jsx(p,{size:17})]})]}),e.jsx("div",{className:"grid-3",children:t.map((a,c)=>e.jsx(k,{project:a,index:c,onOpen:o},a.id))})]}),e.jsx("section",{className:"section container",children:e.jsxs(l,{to:"/terminal",className:"term-cta","data-reveal":!0,"aria-label":"Open the interactive terminal",children:[e.jsxs("div",{className:"term-cta__demo","aria-hidden":"true",children:[e.jsxs("div",{className:"term-cta__bar",children:[e.jsx("span",{className:"term-cta__dot term-cta__dot--r"}),e.jsx("span",{className:"term-cta__dot term-cta__dot--y"}),e.jsx("span",{className:"term-cta__dot term-cta__dot--g"}),e.jsx("span",{className:"term-cta__file",children:"guest@hxndev — zsh"})]}),e.jsxs("div",{className:"term-cta__lines",children:[e.jsxs("p",{children:[e.jsx("span",{className:"term-cta__prompt",children:"$"})," sudo hire-me"]}),e.jsx("p",{className:"term-cta__ok",children:"[sudo] permission granted — excellent decision."}),e.jsxs("p",{children:[e.jsx("span",{className:"term-cta__prompt",children:"$"})," ",e.jsx("span",{className:"term-cta__caret"})]})]})]}),e.jsxs("div",{className:"term-cta__copy",children:[e.jsx("span",{className:"section-index",children:"Prefer the keyboard?"}),e.jsxs("h2",{className:"term-cta__title display",children:["This site has a real, ",e.jsx("span",{className:"gradient-text",children:"working shell."})]}),e.jsx("p",{className:"term-cta__sub",children:"Browse projects, check skills, download the résumé — all from a terminal. Tab completion and command history included."}),e.jsxs("span",{className:"btn btn--primary term-cta__btn",children:[e.jsx(b,{size:18}),e.jsx("span",{children:"Launch terminal"})]})]})]})}),e.jsxs("section",{className:"section container",children:[e.jsxs("div",{className:"section-head",children:[e.jsxs("div",{children:[e.jsx("span",{className:"section-index","data-reveal":!0,children:"Voices"}),e.jsx("h2",{className:"section-title","data-reveal":!0,"data-reveal-delay":80,children:"What colleagues say"})]}),e.jsxs(l,{to:"/recommendations",className:"btn btn--ghost","data-reveal":!0,"data-reveal-delay":120,children:[e.jsx("span",{children:"All 16 recommendations"}),e.jsx(p,{size:17})]})]}),e.jsx("div",{className:"grid-3",children:s.map((a,c)=>e.jsxs("figure",{className:"voice","data-reveal":!0,"data-reveal-delay":c*80,children:[e.jsx(z,{size:26,className:"voice__mark"}),e.jsx("blockquote",{className:"voice__quote",children:a.quote}),e.jsxs("figcaption",{className:"voice__who",children:[e.jsx("span",{className:"voice__name",children:a.name}),e.jsx("span",{className:"voice__title",children:a.title})]})]},a.name))})]}),e.jsx("style",{children:`
        .voice {
          display: flex;
          flex-direction: column;
          gap: 1rem;
      ...
      `})]})};export{G as default};
//# sourceMappingURL=Home-Bdv9c5h7.js.map
